    ...
    return (
        <div className='Block solutionsBlock' id='solutions'>
            <div className="sectionHead">
                ...
                <p className="desc blockDesc" style={{ maxWidth: "520px" }}>Discover how the service meets your team's unique needs and helps you solve even most security challenges.</p>
            </div>
