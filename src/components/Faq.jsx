...
function Faq() {
    ...
    return (
        <div className='Block faqBlock' id='faq'>
            ...
            <center>
                <p className="desc blockDesc">Explore our FAQs to learn more about how our service works, what it offers, and how it can help you secure your enterprise assets.</p>
            </center>
